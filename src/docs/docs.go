...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/service/{svcpID}/{serviceID}": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/admin/serviceproviders/verify/{svcpID}": {
            "patch": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "SVCP verification status to be set to",
                        "name": "verify",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/issue": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Attached image (optional)",
                        "name": "attachedImage",
                        "in": "formData"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Type of issue (refund, system, service)",
                        "name": "issueType",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "ID of associated booking if type is service (optional)",
                        "name": "associatedBookingID",
                        "in": "formData"
                    }
                ],
                "responses": {
        ...
        "/issue/accept/{id}": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID of issue to accept",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/issue/resolve/{id}": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID of issue to resolve",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
